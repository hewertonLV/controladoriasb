...
class ProcessarPreviewImportacaoClientesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        $this->onQueue('clientes-importacao');
    }

    public function handle(ClienteImportacaoProcessor $processor): void
    {
        $importacao = ClienteImportacao::query()->find($this->importacaoId);
        if ($importacao === null) {
            return;
        }
