...
class ProcessarPreviewImportacaoEstoquesJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        $this->onQueue('estoques-importacao');
    }

    public function handle(EstoqueImportacaoProcessor $processor): void
    {
        $importacao = EstoqueImportacao::query()->find($this->importacaoId);
        if ($importacao === null) {
            return;
        }
