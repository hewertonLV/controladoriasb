...
class ProcessarPreviewImportacaoTransferenciasJob implements ShouldQueue
{
    use Dispatchable;
    ...
    {
        $this->onQueue('transferencias-importacao');
    }

    public function handle(TransferenciaImportacaoProcessor $processor): void
    {
        $importacao = TransferenciaImportacao::query()->find($this->importacaoId);
        if ($importacao === null) {
            return;
        }
