...
@section('page-title', 'Importar Clientes')
...
@section('content')
        ...
        <div class="card mb-3" id="card-novas">
            <div class="card-header">
                <h5 class="header-title mb-0">
                    ...
                    Novas clientes <span class="badge bg-success-subtle text-success ms-1" id="count-novas">0</span>
                </h5>
            </div>
        ...
        <div class="card mb-3" id="card-atualizacoes">
            <div class="card-header">
                <h5 class="header-title mb-0">
                    ...
                    Clientes com alterações <span class="badge bg-warning-subtle text-warning ms-1" id="count-atualizacoes">0</span>
                </h5>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('admin.clientes.index') }}" class="btn btn-primary">
                    <i class="ri-list-check-2 me-1"></i> Ir para Clientes
                </a>
            </div>
        </div>
    </div>
    ...
    (function () {
        ...
        const urlIniciar = @json(route('admin.clientes.importar.iniciar'));
        ...
        async function carregarResultadoEConfirmar() {
            try {
                ...
                if (preview.novas.length === 0 && preview.atualizacoes.length === 0) {
                    showAlerta('info', 'A planilha não trouxe novas clientes nem alterações para clientes existentes.');
                }
            } catch (err) {
        ...
        btnConfirmar.addEventListener('click', async () => {
            ...
            if (rowIdsNovas.length === 0 && rowIdsAtual.length === 0) {
                showAlerta('warning', 'Selecione ao menos um cliente.');
                return;
            }
