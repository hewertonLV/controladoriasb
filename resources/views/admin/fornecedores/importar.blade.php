...
@section('title', 'Importar Fornecedores')
@section('page-title', 'Importar Fornecedores')
...
@section('content')
    <div class="card mb-3">
        <div class="card-header d-flex flex-wrap align-items-center gap-2">
            ...
            <a href="{{ route('admin.fornecedores.index') }}" class="btn btn-light">
                <i class="ri-arrow-left-line me-1"></i> Voltar para Fornecedores
            </a>
        </div>
        <div class="card-body">
        ...
        <div class="card mb-3" id="card-novas">
            <div class="card-header">
                <h5 class="header-title mb-0">
                    ...
                    Novas fornecedores <span class="badge bg-success-subtle text-success ms-1" id="count-novas">0</span>
                </h5>
            </div>
        ...
        <div class="card mb-3" id="card-atualizacoes">
            <div class="card-header">
                <h5 class="header-title mb-0">
                    ...
                    Fornecedores com alterações <span class="badge bg-warning-subtle text-warning ms-1" id="count-atualizacoes">0</span>
                </h5>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
    ...
    <div id="resumo-final" class="card d-none">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('admin.fornecedores.index') }}" class="btn btn-primary">
                    <i class="ri-list-check-2 me-1"></i> Ir para Fornecedores
                </a>
            </div>
        </div>
    </div>
    ...
    (function () {
        ...
        const urlIniciar = @json(route('admin.fornecedores.importar.iniciar'));
        ...
        function fmtCampoValor(campo, v) {
            ...
            if (campo === 'id_estado') return (v === null || v === undefined || v === '') ? '—' : escapeHtml(v);
        ...
        function renderNovas(lista) {
            ...
            lista.forEach(item => {
                ...
                tr.innerHTML = `
                    ...
                    <td>${escapeHtml(d.id_estado != null ? String(d.id_estado) : '—')}</td>
                `;
        ...
        async function carregarResultadoEConfirmar() {
            try {
                ...
                if (preview.novas.length === 0 && preview.atualizacoes.length === 0) {
                    showAlerta('info', 'A planilha não trouxe novas fornecedores nem alterações para fornecedores existentes.');
                }
            } catch (err) {
        ...
        btnConfirmar.addEventListener('click', async () => {
            ...
            if (rowIdsNovas.length === 0 && rowIdsAtual.length === 0) {
                showAlerta('warning', 'Selecione ao menos um fornecedor.');
                return;
            }
