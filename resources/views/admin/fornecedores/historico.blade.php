...
@section('title', 'Histórico — ' . $fornecedor->razao_social)
@section('page-title', 'Histórico do Fornecedor')
        ...
        <div class="card-header d-flex flex-wrap align-items-center gap-2">
            ...
            <div class="d-flex flex-wrap gap-2">
                @can('fornecedores.visualizar')
                    <a href="{{ route('admin.fornecedores.show', $fornecedor) }}" class="btn btn-soft-secondary">
                    ...
                    <tbody>
                        @forelse ($historicos as $h)
                            <tr>
                                ...
                                <td>
                                    @if ($h->origem === \App\Models\FornecedorHistorico::ORIGEM_IMPORTACAO_EXCEL)
                                ...
                                <td>{{ $h->user?->name ?? '—' }}</td>
                                <td>
                                    @if ($h->acao === \App\Models\FornecedorHistorico::ACAO_CRIACAO || $h->acao === \App\Models\FornecedorHistorico::ACAO_IMPORTACAO_CRIACAO)
