...
@section('title', 'Frutas do cliente')
@section('page-title', 'Frutas — '.($cliente->fantasia ?: $cliente->razao_social))
    ...
    <form method="post" action="{{ route('admin.captacao.clientes.frutas.sync', $cliente) }}">
        ...
        <div class="card">
            <div class="card-header d-flex flex-wrap gap-2 justify-content-between align-items-center">
                <strong>Frutas que esta loja compra</strong>
                @if ($podeSalvarVinculos ?? false)
                    <input type="search" id="filtro-frutas" class="form-control form-control-sm" style="max-width: 280px;" placeholder="Buscar fruta...">
                @endif
            </div>
            <div class="card-body">
