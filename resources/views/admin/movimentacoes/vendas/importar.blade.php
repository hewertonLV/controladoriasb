...
@section('title', 'Importar NF de Vendas')
...
@section('content')
        ...
        <div class="card-header d-flex flex-wrap align-items-center gap-2">
            <div class="me-auto">
                ...
                <p class="text-muted mb-0">
                    ...
                    <code>A</code> Número da NF · <code>B</code> CNPJ origem ·
                    <code>C</code> CPF/CNPJ cliente · <code>D</code> ID CIGAM fruta ·
                    <code>E</code> Quantidade · <code>F</code> Unidade de medição ·
                    <code>G</code> Valor total da linha.
                </p>
            ...
            <a href="{{ route('admin.movimentacoes.vendas.index') }}" class="btn btn-light">
                <i class="ri-arrow-left-line me-1"></i> Voltar para Vendas
            </a>
        </div>
        <div class="card-body">
            ...
            <div class="card-body d-flex flex-wrap gap-2 align-items-center">
                ...
                <div class="ms-auto d-flex align-items-center gap-2">
                    ...
                    <button type="button" class="btn btn-success" id="btn-confirmar" disabled>
                        ...
                        <i class="ri-check-double-line me-1"></i> Confirmar vendas
                    </button>
                </div>
            </div>
        </div>
    ...
    <div id="resumo-final" class="card d-none">
        ...
        <div class="card-body">
            ...
            <div class="d-flex gap-2 justify-content-end">
                ...
                <a href="{{ route('admin.movimentacoes.vendas.index') }}" class="btn btn-primary">
                    <i class="ri-list-check-2 me-1"></i> Ir para Vendas
                </a>
            </div>
        </div>
    </div>
    ...
    (function () {
        ...
        const urlIniciar = @json(route('admin.movimentacoes.vendas.importar.iniciar'));
        ...
        function aplicarStatusNaUI(s) {
            ...
            if (s.status === 'AGUARDANDO') {
                ...
                progressoTexto.textContent = 'Aguardando fila vendas-importacao.';
        ...
        async function carregarResultado() {
            ...
            if (preview.erros.length > 0) {
                ...
                showAlerta('info', 'Nenhuma linha válida para venda.');
            }
        }
        async function poll() {
