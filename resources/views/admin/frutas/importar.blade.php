...
@section('title', 'Importar Frutas')
@section('page-title', 'Importar Frutas')
...
@section('content')
    <div class="card mb-3">
        <div class="card-header d-flex flex-wrap align-items-center gap-2">
            ...
            <a href="{{ route('admin.frutas.index') }}" class="btn btn-light">
                <i class="ri-arrow-left-line me-1"></i> Voltar para Frutas
            </a>
        </div>
        <div class="card-body">
        ...
        <div class="card mb-3" id="card-novas">
            <div class="card-header">
                <h5 class="header-title mb-0">
                    ...
                    Novas frutas <span class="badge bg-success-subtle text-success ms-1" id="count-novas">0</span>
                </h5>
            </div>
    ...
    (function () {
        ...
        const urlIniciar = @json(route('admin.frutas.importar.iniciar'));
