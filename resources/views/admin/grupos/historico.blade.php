...
@section('title', 'Histórico — ' . $grupo->nome)
@section('page-title', 'Histórico do Grupo')
...
@section('content')
    <div class="card mb-3">
        <div class="card-header d-flex flex-wrap align-items-center gap-2">
            <div class="me-auto">
                <h4 class="header-title mb-1">{{ $grupo->nome }}</h4>
            </div>
                    ...
                    <tbody>
                        @forelse ($historicos as $h)
                            <tr>
                                ...
                                <td>
                                    @if ($h->origem === \App\Models\GrupoHistorico::ORIGEM_IMPORTACAO_EXCEL)
                                ...
                                <td>{{ $h->user?->name ?? '—' }}</td>
                                <td>
                                    @if ($h->acao === \App\Models\GrupoHistorico::ACAO_CRIACAO || $h->acao === \App\Models\GrupoHistorico::ACAO_IMPORTACAO_CRIACAO)
