...
class MovimentacaoFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'id_unidade_negocio_retorno' => null,
            'movimentacao_venda_origem_id' => null,
            'devolucao_origem_id' => null,
            'tipo_devolucao' => null,
            'numero_nf_devolucao' => null,
            'motivo_devolucao' => null,
            'valor_devolucao_total' => '0.00',
            'valor_devolucao_um' => '0.00',
            'valor_devolucao_kg' => '0.00',
            'valor_custo_devolucao' => '0.00',
            'resultado_devolucao' => '0.00',
