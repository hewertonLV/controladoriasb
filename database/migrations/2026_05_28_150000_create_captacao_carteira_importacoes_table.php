...
return new class extends Migration
{
    ...
    {
        Schema::create('captacao_carteira_importacoes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_captacao_carteira')
                ->constrained('captacao_carteiras', indexName: 'cap_cart_imp_carteira_fk')
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('captacao_carteira_importacoes');
    }
};
